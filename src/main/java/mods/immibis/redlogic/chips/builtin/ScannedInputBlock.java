...
public class ScannedInputBlock implements IScannedBlock {
	...
	public ScannedInputBlock(IScanProcess circuit, NodeType nodetype) {
	...
	public IScannedNode getNode(int wireside, int dir) {
		return circuit.getInputNode(dir^1, nodetype);
	}
